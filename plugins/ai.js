...
smd(
  ...
  async (m) => {
    try {
      ...
      await m.send("CHARITY is thinking 🤔");
  ...
  try {
    ...
    if (contentType && contentType.startsWith('image')) {
      ...
      await m.bot.sendFromUrl(
        m.from,
        photoUrl,
        "*PHOTO GENERATED BY Queen_Charity*:",
        m,
        {},
        "image"
      );
    ...
    async (_0x2acf30) => {
      try {
        if (
          ...
          if (
            _0x2acf30.reply_text.includes("Qᴜeeɴ_ᴄʜᴀʀɪᴛʏ• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            _0x2dfb59[0].includes("Qᴜeeɴ_ᴄʜᴀʀɪᴛʏ • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            ...
            try {
              if (_0x2ecd2a) {
                ...
                if (_0x13a11c.toLowerCase().startsWith("reply")) {
                  ...
                  let _0x3f6b59 =
                    "*Qᴜeeɴ_ᴄʜᴀʀɪᴛʏ • ʏᴏᴜʀ ᴀɴᴏɴʏ-ᴍsɢ ʀᴇᴘʟʏ*\n\n*_From @" +
